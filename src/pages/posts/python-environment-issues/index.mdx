...
title: "Re:ゼロから始めるPython環境"
pubDate: 2020-02-27
description: "手把手教你配置Python环境"
author: "Darren Daniel Day"
tags: ["python", "environment setup", "环境配置", "tutorial"]
---
...
3.8.1官方安装包下载地址：[https://www.python.org/downloads/release/python-381/](https://www.python.org/downloads/release/python-381/)
...
<Image src={import("./img/cmd.png")} />

#### WindowsPowershell

Windows Powershell也是一个[可执行文件]。您可以在开始菜单搜索powershell找到它。运行它将产生这样一个蓝色窗口：

<Image src={import("./img//powershell.png")} />

就基本功能而言，powershell和cmd差不多，但是用powershell可以执行linux下的[命令]，而cmd只能执行windows下的[命令]。

### DOS命令
有关[DOS命令]的概念，您可以参考百度百科：[https://baike.baidu.com/item/DOS%E5%91%BD%E4%BB%A4](https://baike.baidu.com/item/DOS%E5%91%BD%E4%BB%A4)
...
<Image src={import("./img/path_step1.png")} />
<Image src={import("./img/path_step2.png")} />
<Image src={import("./img/path_step3.png")} />

值得注意的是这里有两种[Path]环境变量，一种是用户变量，一种是系统变量。一般而言您只需要修改用户变量。

<Image src={import("./img/path_step4.png")} />
...
<Image src={import("./img/py_interact_active.png")} />
...
<Image src={import("./img/py_interact_demo.png")} />

您也可以直接在开始菜单搜索并运行python[解释器]程序进入交互模式。大致效果如下图。

<Image src={import("./img/py_startmenu.png")} />
<Image src={import("./img/py_startmenu_interact.png")} />
...
<Image src={import("./img/py_interact_helloworld.png")} />
...
<Image src={import("./img/exp_ext_script.png")} />
...
<Image src={import("./img/exp_opencmd.png")} />
<Image src={import("./img/pycoding_cmd_promote.png")} />
...
<Image src={import("./img/pycoding_helloworld.png")} />
...
<Image src={import("./img/cmd_absolutepath_helloworld.png")} />
...
<Image src={import("./img/openwith_interpreter.png")} />
...
<Image src={import("./img/pip_fileposition.png")} />

如果您没有安装pip，您可以重新安装python[解释器]并勾选pip。或者您可以参考这里:[https://pip.pypa.io/en/stable/installing/](https://pip.pypa.io/en/stable/installing/)。网页是英文的，如果您有阅读障碍，请使用翻译。
...
您可以在pip的官网：[https://pypi.org/](https://pypi.org/)搜索您要安装的第三方库。

<Image src={import("./img/pypi_search_requests.png")} />
<Image src={import("./img/pypi_search_requests_result.png")} />
<Image src={import("./img/pypi_install_promote.png")} />
...
<Image src={import("./img/install_alreadysatisfied.png")} />
...
<Image src={import("./img/pip_help.png")} />
...
<Image src={import("./img/pip_install_help_1.png")} />
...
<Image src={import("./img/pip_install_help_2.png")} />
...
如果您希望修改默认的安装地址为国内镜像，您可以参考这篇文章：[https://blog.csdn.net/sinat_21591675/article/details/82770360](https://blog.csdn.net/sinat_21591675/article/details/82770360)
...
<Image src={import("./img/idle_shell.png")} />
...
<Image src={import("./img/idle_demo.png")} />
...
<Image src={import("./img/idle_interact_infer.png")} />
<Image src={import("./img/idle_interact_result.png")} />

以上是简单的[IDLE]中的操作。如果您有兴趣，可以自行探索其他功能（例如格式化代码、调试、有趣的Turtle图形化库的官方示例代码等）。

### VSCode

Visual Studio Code（简称vscode）是微软开发的一款轻量的代码编辑器。她不是像Sublime Text那样的纯文本编辑，也不是像Visual Studio那样的大型集成开发环境，这一点使得大多数的开发者选择了她。更酷的是，她完全开源免费。您可以在GitHub上找到她的源码：[https://github.com/microsoft/vscode](https://github.com/microsoft/vscode)。

您可以通过这个链接下载她：[https://code.visualstudio.com/Download](https://code.visualstudio.com/Download)。
...
<Image src={import("./img/vscode_plugin_python.png")} />
...
<Image src={import("./img/vscode_openfolder.png")} />

下面是简单的界面介绍：

<Image src={import("./img/vscode_ui_exp.png")} />

> 您可能注意到了背景图片`津岛善子 下界の儀式`。背景图片效果来自于插件vscode-background，如果您需要，您可以自行安装配置。

接下来几张图简单介绍如何在vscode中调试运行您的python脚本。

<Image src={import("./img/vscode_dbg_pyfile.png")} />
<Image src={import("./img/vscode_dbg_result.png")} />

如果您发现频繁选择第一个`Python File`[选项]比较麻烦，您可以按照如下步骤添加配置文件。

<Image src={import("./img/vscode_dbgconfig_pyfile.png")} />
<Image src={import("./img/vscode_dbgconfig_json.png")} />
...
<Image src={import("./img/vscode_dbg_breakpoint.png")} />

接下来按F5

<Image src={import("./img/vscode_dbg_pause.png")} />
<Image src={import("./img/vscode_dbg_nextstep.png")} />
...
[Pycharm]有社区版（Community）和专业版（Professional），其中社区版是免费的，而专业版是收费的。专业版的功能比社区版的相对多一些。您可以在这里下载它：[https://www.jetbrains.com/pycharm/download/#section=windows](https://www.jetbrains.com/pycharm/download/#section=windows)。

如果您选择了专业版，您将需要激活，或者免费试用一段时间。如果您是学生，您可以使用学生认证进行激活，并免费使用Pycharm到您毕业为止，可以参考这篇文章：[https://blog.csdn.net/qq_36667170/article/details/79905198](https://blog.csdn.net/qq_36667170/article/details/79905198)。如果您不是学生，又希望使用专业版，请考虑购买许可。**如果您尝试使用破解版，并对Jet Brains公司造成了损失而被追究责任，笔者概不负责**。

本教程将演示如何使用社区版。

安装[选项]您可以根据个人需要进行变更。安装完毕后打开，您将看到这样的界面：

<Image src={import("./img/pyc_start.png")} />

您可以选择第二个[选项]，打开一个文件夹，这和vscode有些相似。您也可以选择第一个[选项]新建一个项目。在这里，笔者将展示创建项目。

<Image src={import("./img/pyc_newproj_1.png")} />
<Image src={import("./img/pyc_newproj_2.png")} />

选好[解释器]后点击create。进入后您将大致看到这样的界面。

<Image src={import("./img/pyc_tips.png")} />

您可以在项目中新建一个脚本文件。笔者在此使用的脚本代码和vscode中的示例一样。

<Image src={import("./img/pyc_newfile.png")} />
<Image src={import("./img/pyc_dbgdemo_1.png")} />

如果您在创建项目的时候选择了虚拟环境（如果您没有看上述教程，而是按照默认创建了项目，则会有一个虚拟环境），您可以在设置中修改项目的[解释器]：

<Image src={import("./img/pyc_opensettings.png")} />
<Image src={import("./img/pyc_settings_projinterpreter.png")} />
...
<Image src={import("./img/pyc_dbgdemo_run.png")} />

您将看到这样的结果：

<Image src={import("./img/pyc_run.png")} />

通过以上方法运行过一次以后，pycharm将会为您生成一个运行配置。您可以使用这个配置，点击左上角的绿色小三角形运行。

下面笔者将介绍如何手动配置运行配置。

<Image src={import("./img/pyc_addconfig.png")} />
<Image src={import("./img/pyc_runconfig.png")} />

配置完毕后，您可以选择需要的配置，然后点击右上角的绿色小三角形运行。

[Pycharm]的调试功能，笔者也用一张图简单概括，仅介绍界面。有关调试的一些概念详见vscode的调试部分。

<Image src={import("./img/pyc_dbgdemo_2.png")} />
